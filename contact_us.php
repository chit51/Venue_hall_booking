            ...
            <div class="card rounded-0 card-outline card-maroon shadow" >
                <div class="card-body rounded-0">
                    ...
                    <form action="" id="message-form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-sm form-control-border" id="fullname" name="fullname" required placeholder="your name">
...
<script>
   $(function() {
    $('#message-form').submit(function(e) {
        ...
        var indianMobileRegex = /^(?:\+91|91)?[6-9][0-9]{9}$/;

        // Regex for Full Name (only alphabets and spaces, minimum 2 characters)
        var nameRegex = /^[a-zA-Z\s]{2,}$/;

        if (!nameRegex.test(fullName)) {
            alert_toast("Please enter a valid full name (letters only).", 'error');
            return false;
        }

        if (!indianMobileRegex.test(contactNumber)) {
            alert_toast("Please enter a valid mobile number.", 'error');
            return false;
        }
