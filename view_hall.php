...
<div class="container-fluid">
    <dl>
    <dt class="hall-image-view-holder">
            <img src="<?= $image_path ?>" alt="Hall Image" class="img-fluid bg-gradient-gray hall-image-view">
        </dt>
...
<dd class='pl-4 fs-5 fw-semibold'>
    <?= isset($location) ? $location : 'Not specified' ?>
</dd>
